...
bool Graphics::LoadAnimation(std::string AnimationName, Actor* Actor, std::vector<std::string>Textures, int TileSizeX, int TileSizeY, int TileLeft, int TileTop, int NumOfFrames) {
